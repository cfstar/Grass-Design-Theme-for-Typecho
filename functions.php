...
function themeConfig($form) {
    ...
    $headImage = new Typecho_Widget_Helper_Form_Element_Text('headImage', NULL, NULL, _t('首页头图地址'), _t('在这里填入一个图片 URL 地址, 以设置首页欢迎头图'));
    ...
    $menuList = new Typecho_Widget_Helper_Form_Element_Textarea('menuList', null, null, _t('菜单项'), _t('该项格式请看官方文档。'));
